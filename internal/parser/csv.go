...
// ChunkCSVtoTransactions reads and parses the CSV file into a slice of Transactions.
func ChunkCSVtoTransactions(file io.Reader) ([]transaction.Transaction, error) {
	...
	// Read each record.
	recordNumber := 0 // Including header
	for {
		record, err := reader.Read()
		recordNumber++
		if err != nil {
